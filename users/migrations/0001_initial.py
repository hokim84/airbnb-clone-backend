    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('real_name', models.CharField(default='홍길동', max_length=40)),
                ...
                ('language', models.CharField(choices=[('KR', 'Korea'), ('EN', 'English')], max_length=20, null=True)),
                ('currency', models.CharField(choices=[('won', 'Korean Won'), ('USD', 'Dollar')], max_length=10, null=True)),
